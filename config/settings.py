...
# ── Email Configuration ───────────────────────────────────────────────────────
# For local development, send emails to the console.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'EastWest Portal <no-reply@std.ewubd.edu>')
PORTAL_NAME = "EastWest University Portal"
